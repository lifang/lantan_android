...
public class LanTanSolveHuaHen extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv.setImageResource(R.drawable.hh_icon);
		tv.setText(getApplication().getResources().getString(R.string.solveHH));
	...
	public void loadData(){
		...
		ib1.add(new ItemBean(R.drawable.hhwt,2));
		ib1.add(new ItemBean(R.string.hhwt,1));
		...
		ib2.add(new ItemBean(R.string.hhjj1,1));
		ib2.add(new ItemBean(R.string.hhjj2,1));
		ib2.add(new ItemBean(R.string.solvetedian,1));
		ib2.add(new ItemBean(R.drawable.hhjj,2));
		ib2.add(new ItemBean(R.string.hhjj3,1));
