...
public class LanTanSolveLunTai extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv.setImageResource(R.drawable.lt_icon);
		tv.setText(getApplication().getResources().getString(R.string.solveLT));
	...
	public void loadData(){
		...
		ib1.add(new ItemBean(R.drawable.ltwt,2));
		ib1.add(new ItemBean(R.string.ltwt,1));
		...
		ib2.add(new ItemBean(R.drawable.cspz,2));
		ib2.add(new ItemBean(R.string.ltjj1,1));
		ib2.add(new ItemBean(R.string.ltjj2,1));
		ib2.add(new ItemBean(R.string.ltjj3,1));
		ib2.add(new ItemBean(R.string.ltjj4,1));
		ib2.add(new ItemBean(R.string.ltjj5,1));
		ib2.add(new ItemBean(R.string.ltjj6,1));
		ib2.add(new ItemBean(R.string.ltjj7,1));
		ib2.add(new ItemBean(R.string.solvetedian,1));
		ib2.add(new ItemBean(R.drawable.ltjj,2));
		ib2.add(new ItemBean(R.string.ltjj8,1));
		...
		ib3.add(new ItemBean(R.drawable.ltclqian,2));
		ib3.add(new ItemBean(R.string.solveqmhou,1));
		ib3.add(new ItemBean(R.drawable.ltclhou,2));
		ib3.add(new ItemBean(R.string.solveqmduibi,1));
		ib3.add(new ItemBean(R.drawable.ltdb,2));
