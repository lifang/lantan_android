...
public class LanTanSolveZiWaiXian extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv.setImageResource(R.drawable.zwx_icon);
		tv.setText(getApplication().getResources().getString(R.string.solveZWX));
	...
	public void loadData(){
		...
		ib1.add(new ItemBean(R.drawable.zwxwt,2));
		ib1.add(new ItemBean(R.string.zwxwt,1));
		...
		ib2.add(new ItemBean(R.string.zwxjj1,1));
		ib2.add(new ItemBean(R.string.zwxjj2,1));
		ib2.add(new ItemBean(R.string.solvetedian,1));
		ib2.add(new ItemBean(R.drawable.zwxjj,2));
		ib2.add(new ItemBean(R.string.zwxjj3,1));
		...
		ib3.add(new ItemBean(R.drawable.zwxclqian,2));
		ib3.add(new ItemBean(R.string.solveqmhou,1));
		ib3.add(new ItemBean(R.drawable.zwxclhou,2));
		ib3.add(new ItemBean(R.string.solveqmduibi,1));
		ib3.add(new ItemBean(R.drawable.zwxdb,2));
