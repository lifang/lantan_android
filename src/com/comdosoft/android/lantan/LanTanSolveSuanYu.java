...
public class LanTanSolveSuanYu extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv.setImageResource(R.drawable.sy_icon);
		tv.setText(getApplication().getResources().getString(R.string.solveSY));
	...
	public void loadData(){
		...
		ib1.add(new ItemBean(R.drawable.sywt,2));
		ib1.add(new ItemBean(R.string.sywt,1));
		...
		ib2.add(new ItemBean(R.string.syjj1,1));
		ib2.add(new ItemBean(R.string.syjj2,1));
		ib2.add(new ItemBean(R.string.solvetedian,1));
		ib2.add(new ItemBean(R.drawable.syjj,2));
		ib2.add(new ItemBean(R.string.syjj3,1));
