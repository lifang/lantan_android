...
public class LanTanSolveChongShi extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv.setImageResource(R.drawable.cs_icon);
		tv.setText(getApplication().getResources().getString(R.string.solveCS));
	...
	public void loadData(){
		...
		ib1.add(new ItemBean(R.string.cswt,1));
		ib1.add(new ItemBean(R.drawable.cswt,2));
		...
		ib2.add(new ItemBean(R.string.csjj1,1));
		ib2.add(new ItemBean(R.string.csjj2,1));
		ib2.add(new ItemBean(R.string.csjj3,1));
		ib2.add(new ItemBean(R.string.solvetedian,1));
		ib2.add(new ItemBean(R.drawable.csjj,2));
		...
		ib3.add(new ItemBean(R.drawable.csxg1,2));
		ib3.add(new ItemBean(R.string.solveqmhou,1));
		ib3.add(new ItemBean(R.drawable.csxg2,2));
		ib3.add(new ItemBean(R.string.solveqmduibi,1));
		ib3.add(new ItemBean(R.drawable.csxg3,2));
